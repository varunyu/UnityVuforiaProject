...
public class DDAS : MonoBehaviour
{
    ...
    private void UpdateTotalScoreUI()
    {
        ...
        tmpTotalScore.transform.GetChild(4).GetComponent<Text>().text = total_Overall_Time.ToString("F2") + " cm";
    }
    ...
    private void AddNewScoringUI(int index)
    {
        ...
        tmpTrialScore.transform.GetChild(4).GetComponent<Text>().text = tmp_Overall_Time.ToString("F2") + " cm";
    }
